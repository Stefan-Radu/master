...
\newglossaryentrywithacronym{BF}{Brainf*ck}{ 
    Brainf*ck is a very famous esoteric programming language, known for its minimalis syntax which consists of only the following eight instructions: \cc{+ \_ < > . ; [ ]} \cite{brainfk}
}
...
\newglossaryentrywithacronym{BNF}{Backus-Naur Form}{ 
    A style of notation for context-free grammars, used in Computer Science to formally describe the syntax of programming languages or formal languages. \cite{bnf}
}
...
\newacro{IRSB}{Intermediate Representation (IR) Super Block}
